...
public class MathGame {
    ...
    public MathGame(Player player1, Player player2, Player player3, Scanner scanner) {
        ...
        this.timedInput = new TimedInput(5, scanner);
    ...
    public void playRound() {
        boolean isPreviousIncorrect = false;
    ...
    private boolean askQuestion() {
        ...
        int playerAnswer = timedInput.start(); // get player's answer using Scanner
